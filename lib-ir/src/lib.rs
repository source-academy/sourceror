...
pub enum ExprKind {
    ...
    /*TypeGuard {
        ...
        true_expr: Box<Expr>,
        false_expr: Box<Expr>,
    },*/ // TODO: Use typeguards for imports and builtin ops, currently blocked until "Unified Statements and Expressions" is implemented.  When that is implemented, a load from a variable should not allow narrowing of type.
    VarName {
        source: TargetExpr,
    ...
    Sequence {
        // this is a hack to make lambda functions and import typechecks work; eventually statements and expressions should be unified
        local: VarType,
...
impl Program {
    ...
    pub fn new(
        ...
        Program,
        [FuncIdx; NUM_BUILTINS as usize],
        HashMap<String, FuncIdx>,
    ) {
